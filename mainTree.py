...
def main():
    ...
    """
    file = open('PokemonTraining1.csv')
    """
    ...
    # Generate printedTree
    # file = open('printedTree1.py', 'w')
    # file.write(str(tree))
    # file.close()
    # Generate program
    file = open('programTrashBin.py', 'w')
    ...
    file.write("\t\troot = Node.Node(list(tempDict)[0], tempDict[list(tempDict)[0]])\n")
    file.write("\t\ttempDict = tempDict[list(tempDict)[0]]\n")
